...
<body>
			...
			<div class="wrap-login100">
				<form action="" method="POST" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
					...
					<div class="container-login100-form-btn">
						<button tpye="login" name="login" class="login100-form-btn">
							Login
						</button>
					</div>
					...
					<div class="flex-col-c p-t-170 p-b-40">
						...
						<a href="../register/registermasyarakat.php" class="txt3">
							Klik Untuk Daftar
						</a>
					</div>
				</form>
    ...
    if(isset($_POST['login'])){
        ...
        if($jumlahdata >= 1){
            ...
            <script type="text/javascript">
                alert('gagal masuk');
                setTimeout("location.href='../login/loginmasyarakat.php'");
            </script>
            <?php
        }
    }
